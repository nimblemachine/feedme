...
A Django-based system for making news and scraped data useful for building web audiences.
...
.. code-block:: bash
    ...
    heroku run python feedme/manage.py syncdb --noinput --settings=config.settings
    heroku run python feedme/manage.py migrate --settings=config.settings
    heroku run python feedme/manage.py collectstatic --settings=config.settings
